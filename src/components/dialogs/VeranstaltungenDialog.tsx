...
export function VeranstaltungenDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: VeranstaltungenDialogProps) {
  ...
  async function handleAiExtract(file?: File) {
    ...
    try {
      ...
      const schema = `{\n  "titel": string | null, // Titel der Veranstaltung\n  "beschreibung": string | null, // Beschreibung\n  "datum_uhrzeit": string | null, // YYYY-MM-DDTHH:MM\n  "anmeldeschluss": string | null, // YYYY-MM-DD\n  "veranstaltungsart": LookupValue | null, // Veranstaltungsart (select one key: "vortrag" | "workshop" | "mitgliederversammlung" | "networking" | "sonstiges") mapping: vortrag=Vortrag, workshop=Workshop, mitgliederversammlung=Mitgliederversammlung, networking=Networking, sonstiges=Sonstiges\n  "veranstaltungsort": string | null, // Veranstaltungsort\n  "max_teilnehmer": number | null, // Maximale Teilnehmerzahl\n  "verantwortlicher": string | null, // Verantwortliche Person\n  "bemerkungen_veranstaltung": string | null, // Bemerkungen\n}`;
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'anmeldeschluss': (
      <div key="anmeldeschluss" className="space-y-1.5">
      ...
      <div key="veranstaltungsart" className="space-y-1.5">
        ...
        <div role="radiogroup" className="flex flex-wrap gap-1.5">
          <button
            type="button"
            role="radio"
            aria-checked={lookupKey(fields.veranstaltungsart) === 'vortrag'}
            onClick={() => setFields(f => ({ ...f, veranstaltungsart: (lookupKey(f.veranstaltungsart) === 'vortrag' ? undefined : 'vortrag') as any }))}
            className={`inline-flex items-center rounded-full border px-3 py-1.5 text-sm font-medium transition-colors ${
              lookupKey(fields.veranstaltungsart) === 'vortrag'
          ...
          <button
            type="button"
            role="radio"
            aria-checked={lookupKey(fields.veranstaltungsart) === 'workshop'}
            onClick={() => setFields(f => ({ ...f, veranstaltungsart: (lookupKey(f.veranstaltungsart) === 'workshop' ? undefined : 'workshop') as any }))}
            className={`inline-flex items-center rounded-full border px-3 py-1.5 text-sm font-medium transition-colors ${
              lookupKey(fields.veranstaltungsart) === 'workshop'
                ? 'bg-foreground text-background border-foreground'
                : 'bg-background text-foreground border-input hover:bg-accent'
            }`}
          >
          ...
          <button
            type="button"
            role="radio"
            aria-checked={lookupKey(fields.veranstaltungsart) === 'mitgliederversammlung'}
            onClick={() => setFields(f => ({ ...f, veranstaltungsart: (lookupKey(f.veranstaltungsart) === 'mitgliederversammlung' ? undefined : 'mitgliederversammlung') as any }))}
            className={`inline-flex items-center rounded-full border px-3 py-1.5 text-sm font-medium transition-colors ${
              lookupKey(fields.veranstaltungsart) === 'mitgliederversammlung'
                ? 'bg-foreground text-background border-foreground'
                : 'bg-background text-foreground border-input hover:bg-accent'
            }`}
          >
          ...
          <button
            type="button"
            role="radio"
            aria-checked={lookupKey(fields.veranstaltungsart) === 'networking'}
            onClick={() => setFields(f => ({ ...f, veranstaltungsart: (lookupKey(f.veranstaltungsart) === 'networking' ? undefined : 'networking') as any }))}
            className={`inline-flex items-center rounded-full border px-3 py-1.5 text-sm font-medium transition-colors ${
              lookupKey(fields.veranstaltungsart) === 'networking'
                ? 'bg-foreground text-background border-foreground'
                : 'bg-background text-foreground border-input hover:bg-accent'
            }`}
          >
          ...
          <button
            type="button"
            role="radio"
            aria-checked={lookupKey(fields.veranstaltungsart) === 'sonstiges'}
            onClick={() => setFields(f => ({ ...f, veranstaltungsart: (lookupKey(f.veranstaltungsart) === 'sonstiges' ? undefined : 'sonstiges') as any }))}
            className={`inline-flex items-center rounded-full border px-3 py-1.5 text-sm font-medium transition-colors ${
              lookupKey(fields.veranstaltungsart) === 'sonstiges'
                ? 'bg-foreground text-background border-foreground'
                : 'bg-background text-foreground border-input hover:bg-accent'
            }`}
          >
    ...
    'verantwortlicher': (
      <div key="verantwortlicher" className="space-y-1.5">
    ...
    'bemerkungen_veranstaltung': (
      <div key="bemerkungen_veranstaltung" className="space-y-1.5">
  ...
  const FIELD_LABELS: Record<string, string> = {"titel": "Titel der Veranstaltung", "beschreibung": "Beschreibung", "datum_uhrzeit": "Datum & Uhrzeit", "anmeldeschluss": "Anmeldeschluss", "veranstaltungsart": "Veranstaltungsart", "veranstaltungsort": "Veranstaltungsort", "max_teilnehmer": "Maximale Teilnehmerzahl", "verantwortlicher": "Verantwortliche Person", "bemerkungen_veranstaltung": "Bemerkungen"};
