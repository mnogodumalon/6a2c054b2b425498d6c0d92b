...
interface BeitraegeZahlungenDialogProps {
  ...
  defaultValues?: BeitraegeZahlungen['fields'];
...
export function BeitraegeZahlungenDialog({ open, onClose, onSubmit, defaultValues, recordId, mitgliederList, enablePhotoScan = true, enablePhotoLocation = true }: BeitraegeZahlungenDialogProps) {
  ...
  useEffect(() => {
    if (open) {
      setFields(applyDefaults((defaultValues ?? {}) as Record<string, unknown>, formEnhancements.defaults) as Partial<BeitraegeZahlungen['fields']>);
      setPreview(null);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const clean = cleanFieldsForApi(merged, 'beitraege_&_zahlungen');
    ...
    'bemerkungen_zahlung': (
      <div key="bemerkungen_zahlung" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Zahlungsreferenz, Besonderheiten..."
