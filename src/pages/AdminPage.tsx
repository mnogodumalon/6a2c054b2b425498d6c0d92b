...
const VERANSTALTUNGEN_FIELDS = [
  ...
  { key: 'anmeldeschluss', label: 'Anmeldeschluss', type: 'date/date' },
  { key: 'veranstaltungsart', label: 'Veranstaltungsart', type: 'lookup/select', options: [{ key: 'vortrag', label: 'Vortrag' }, { key: 'workshop', label: 'Workshop' }, { key: 'mitgliederversammlung', label: 'Mitgliederversammlung' }, { key: 'networking', label: 'Networking' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'veranstaltungsort', label: 'Veranstaltungsort', type: 'string/text' },
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'veranstaltungsteilnahmen' && fieldKey === 'veranstaltung') {
    ...
    >
      ...
      {(createEntity === 'veranstaltungsteilnahmen' || dialogState?.entity === 'veranstaltungsteilnahmen') && (
        <VeranstaltungsteilnahmenDialog
          ...
          onSubmit={dialogState?.entity === 'veranstaltungsteilnahmen' ? handleUpdate : (fields: any) => handleCreate('veranstaltungsteilnahmen', fields)}
          defaultValues={dialogState?.entity === 'veranstaltungsteilnahmen' ? dialogState.record?.fields : undefined}
      ...
      {viewState?.entity === 'veranstaltungsteilnahmen' && (
        <VeranstaltungsteilnahmenViewDialog
          open={viewState?.entity === 'veranstaltungsteilnahmen'}
